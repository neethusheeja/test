...
namespace Flybycart.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            string connection = "server=localhost;database=flybycart;user=root;password=database;port=3306"; // declaring a connection string
